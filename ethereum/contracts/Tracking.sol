...
contract Tracking{
    ...
    //events
    event updateStatusRecycler(address indexed recycler, address indexed plasticBottleAddress, string indexed status, uint  time);
     event updateStatusMachine(address indexed plasticBottleAddress, address indexed sellerAddress, string indexed status, uint time); 
